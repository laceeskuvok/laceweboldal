...
"[project]/node_modules/@supabase/postgrest-js/dist/cjs/version.js [middleware] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/node_modules/@supabase/postgrest-js/dist/cjs/constants.js [middleware] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
const version_1 = __turbopack_context__.r("[project]/node_modules/@supabase/postgrest-js/dist/cjs/version.js [middleware] (ecmascript)");
...
const PostgrestFilterBuilder_1 = __importDefault(__turbopack_context__.r("[project]/node_modules/@supabase/postgrest-js/dist/cjs/PostgrestFilterBuilder.js [middleware] (ecmascript)"));
const constants_1 = __turbopack_context__.r("[project]/node_modules/@supabase/postgrest-js/dist/cjs/constants.js [middleware] (ecmascript)");
/**
 * PostgREST client.
 *
...
"[project]/node_modules/@supabase/realtime-js/dist/main/WebSocket.js [middleware] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
if ("TURBOPACK compile-time truthy", 1) {
    ...
    WebSocketImpl = __turbopack_context__.r("[project]/node_modules/ws/index.js [middleware] (ecmascript)");
} else //TURBOPACK unreachable
;
exports.default = WebSocketImpl; //# sourceMappingURL=WebSocket.js.map
}),
"[project]/node_modules/@supabase/realtime-js/dist/main/lib/version.js [middleware] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/node_modules/@supabase/realtime-js/dist/main/lib/constants.js [middleware] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
const version_1 = __turbopack_context__.r("[project]/node_modules/@supabase/realtime-js/dist/main/lib/version.js [middleware] (ecmascript)");
exports.DEFAULT_HEADERS = {
...
"[project]/node_modules/@supabase/realtime-js/dist/main/lib/serializer.js [middleware] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/node_modules/@supabase/realtime-js/dist/main/lib/timer.js [middleware] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/node_modules/@supabase/realtime-js/dist/main/lib/transformers.js [middleware] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/node_modules/@supabase/realtime-js/dist/main/lib/push.js [middleware] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";

Object.defineProperty(exports, "__esModule", {
    value: true
});
const constants_1 = __turbopack_context__.r("[project]/node_modules/@supabase/realtime-js/dist/main/lib/constants.js [middleware] (ecmascript)");
class Push {
    /**
...
"[project]/node_modules/@supabase/realtime-js/dist/main/RealtimePresence.js [middleware] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/node_modules/@supabase/realtime-js/dist/main/RealtimeChannel.js [middleware] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
const constants_1 = __turbopack_context__.r("[project]/node_modules/@supabase/realtime-js/dist/main/lib/constants.js [middleware] (ecmascript)");
const push_1 = __importDefault(__turbopack_context__.r("[project]/node_modules/@supabase/realtime-js/dist/main/lib/push.js [middleware] (ecmascript)"));
const timer_1 = __importDefault(__turbopack_context__.r("[project]/node_modules/@supabase/realtime-js/dist/main/lib/timer.js [middleware] (ecmascript)"));
const RealtimePresence_1 = __importDefault(__turbopack_context__.r("[project]/node_modules/@supabase/realtime-js/dist/main/RealtimePresence.js [middleware] (ecmascript)"));
const Transformers = __importStar(__turbopack_context__.r("[project]/node_modules/@supabase/realtime-js/dist/main/lib/transformers.js [middleware] (ecmascript)"));
const transformers_1 = __turbopack_context__.r("[project]/node_modules/@supabase/realtime-js/dist/main/lib/transformers.js [middleware] (ecmascript)");
...
"[project]/node_modules/@supabase/realtime-js/dist/main/RealtimeClient.js [middleware] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
const WebSocket_1 = __importDefault(__turbopack_context__.r("[project]/node_modules/@supabase/realtime-js/dist/main/WebSocket.js [middleware] (ecmascript)"));
const constants_1 = __turbopack_context__.r("[project]/node_modules/@supabase/realtime-js/dist/main/lib/constants.js [middleware] (ecmascript)");
const serializer_1 = __importDefault(__turbopack_context__.r("[project]/node_modules/@supabase/realtime-js/dist/main/lib/serializer.js [middleware] (ecmascript)"));
const timer_1 = __importDefault(__turbopack_context__.r("[project]/node_modules/@supabase/realtime-js/dist/main/lib/timer.js [middleware] (ecmascript)"));
const transformers_1 = __turbopack_context__.r("[project]/node_modules/@supabase/realtime-js/dist/main/lib/transformers.js [middleware] (ecmascript)");
const RealtimeChannel_1 = __importDefault(__turbopack_context__.r("[project]/node_modules/@supabase/realtime-js/dist/main/RealtimeChannel.js [middleware] (ecmascript)"));
const noop = ()=>{};
const WORKER_SCRIPT = `
...
class RealtimeClient {
     ...
     */ connect() {
        ...
        if (this.transport) {
            ...
            const isBrowser = ("TURBOPACK compile-time value", "undefined") !== 'undefined' && this.transport === window.WebSocket;
            if ("TURBOPACK compile-time falsy", 0) //TURBOPACK unreachable
            ;
            else {
...
"[project]/node_modules/@supabase/realtime-js/dist/main/index.js [middleware] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
const RealtimeClient_1 = __importDefault(__turbopack_context__.r("[project]/node_modules/@supabase/realtime-js/dist/main/RealtimeClient.js [middleware] (ecmascript)"));
exports.RealtimeClient = RealtimeClient_1.default;
const RealtimeChannel_1 = __importStar(__turbopack_context__.r("[project]/node_modules/@supabase/realtime-js/dist/main/RealtimeChannel.js [middleware] (ecmascript)"));
...
const RealtimePresence_1 = __importStar(__turbopack_context__.r("[project]/node_modules/@supabase/realtime-js/dist/main/RealtimePresence.js [middleware] (ecmascript)"));
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$supabase$2f$realtime$2d$js$2f$dist$2f$main$2f$index$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@supabase/realtime-js/dist/main/index.js [middleware] (ecmascript)");
...
class SupabaseClient {
     ...
     */ get storage() {
        return new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$supabase$2f$storage$2d$js$2f$dist$2f$module$2f$StorageClient$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__["StorageClient"](this.storageUrl.href, this.headers, this.fetch);
    }
    /**
     * Perform a query on a table or a view.
     *
    ...
    _initRealtimeClient(options) {
        return new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$supabase$2f$realtime$2d$js$2f$dist$2f$main$2f$index$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__["RealtimeClient"](this.realtimeUrl.href, Object.assign(Object.assign({}, options), {
...
//# sourceMappingURL=node_modules_3b40eb5b._.js.map