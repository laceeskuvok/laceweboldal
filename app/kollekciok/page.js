...
const mainCollections = [
  {
    ...
    items: [
      { name: "Esküvői hírlap borító", img: "/images/eskuvoihirlap.jpg" },
      { name: "Páros interjú oldal", img: "/images/eskuvoihirlap.jpg" },
      { name: "Programoldal", img: "/images/eskuvoihirlap.jpg" },
    ],
    bgColor: "#FAF7F6",
  },
  {
    ...
    name: "Történetek képekben",
    price: "34 900 Ft",
    description: "Színes, történetmesélő képes kollekció személyre szabva.",
    items: [
      { name: "Meghívó", img: "/images/eskuvoihirlap.jpg" },
      { name: "Idézetkártya", img: "/images/eskuvoihirlap.jpg" },
      { name: "Ajándékkísérő", img: "/images/eskuvoihirlap.jpg" },
    ],
    bgColor: "#F5EBEB",
  },
  {
...
const extraCollection = {
  ...
  name: "+ Extrák",
  description:
    "Tedd teljessé a nagy napot egyedi kiegészítőkkel, melyek tökéletesen illeszkednek a választott kollekció stílusához.",
  items: [
    { name: "Egyedi menükártya", img: "/images/eskuvoihirlap.jpg" },
    { name: "Esküvői weboldal", img: "/images/eskuvoihirlap.jpg" },
    { name: "Ajándékkísérő", img: "/images/eskuvoihirlap.jpg" },
    { name: "Kézzel írt levél", img: "/images/eskuvoihirlap.jpg" },
  ],
  bgColor: "#EFEAE6",
};
const remainingCollections = [
  {
    ...
    items: [
      { name: "Vintage meghívó", img: "/images/eskuvoihirlap.jpg" },
      { name: "Ültetőkártya", img: "/images/eskuvoihirlap.jpg" },
      { name: "Asztalszám", img: "/images/eskuvoihirlap.jpg" },
    ],
    bgColor: "#EFEAE6",
  },
  {
    ...
    items: [
      { name: "Minimal meghívó", img: "/images/eskuvoihirlap.jpg" },
      { name: "Ültetőkártya", img: "/images/eskuvoihirlap.jpg" },
  ...
  },
  {
    ...
    items: [
      { name: "Boho meghívó", img: "/images/eskuvoihirlap.jpg" },
      { name: "Természetes ültetőkártya", img: "/images/eskuvoihirlap.jpg" },
      { name: "Kézzel írt üzenetkártya", img: "/images/eskuvoihirlap.jpg" },
    ],
    bgColor: "#F6EFE9",
  },
];
...
// === FELTURBÓZOTT Kollekció Szekció Parallax Effekttel ===
        ...
        <div className="max-w-7xl w-full grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <motion.span
              ...
              className="font-serif text-7xl lg:text-8xl text-brand-rose opacity-20"
            >
              {id}
            </motion.span>
            <motion.h2
              variants={itemVariants}
              className="font-serif text-5xl lg:text-6xl text-brand-text -mt-8"
            >
              {name}
            </motion.h2>
            <motion.p
              variants={itemVariants}
              className="mt-4 text-lg text-gray-600 max-w-md leading-relaxed font-body"
            >
              {description}
            </motion.p>
            <motion.div
              variants={itemVariants}
              className="mt-8 border-t border-brand-rose/30 pt-6"
            >
              <h4 className="font-sans uppercase tracking-widest text-brand-text mb-4">
                Kollekció elemei
              </h4>
