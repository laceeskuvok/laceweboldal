...
const WeddingMessages = () => {
  ...
  return (
    <section id="uzenet" className="max-w-xl mx-auto px-6 py-20">
      <div className="text-center">
        <h3 className="text-3xl font-semibold text-brand-rose mb-4">Jó Kívánságok</h3>
        <p className="text-gray-600 mb-12">
          Hagyjatok nekünk egy kedves üzenetet, amit az esküvő után is örömmel
          olvasunk majd vissza! Kattintsatok a borítékokra a kinyitáshoz.
        </p>
      </div>
      ...
      <div className="space-y-8">
        {messages.length === 0 ? (
          ...
          displayedMessages.map((msg, index) => (
            <EnvelopeMessage key={msg.id} msg={msg} index={index} />
          ))
        )}
      </div>
...
const EnvelopeMessage = ({ msg, index }) => {
  ...
  return (
    <motion.div
      ...
      className="w-full max-w-md mx-auto cursor-pointer perspective-[1500px]"
